...
def obtener_datos():
    try:
        ...
        while not os.path.exists("C:/Users/ASUS/OneDrive/Documentos/Gomory-Hu-Tree/output.txt"):
            time.sleep(1)  # Esperar 1 segundo antes de verificar nuevamente

        # Eliminar la primera línea del archivo datos_grafo.txt
        eliminar_primera_linea("C:/Users/ASUS/OneDrive/Documentos/Gomory-Hu-Tree/datos_grafo.txt", "C:/Users/ASUS/OneDrive/Documentos/Gomory-Hu-Tree/datos_grafo_temp.txt")

        # Dibujar el grafo del archivo datos_grafo_temp.txt
        dibujar_grafo("C:/Users/ASUS/OneDrive/Documentos/Gomory-Hu-Tree/datos_grafo_temp.txt", guardar_imagen=True)

        # Leer el archivo output.txt
        with open("C:/Users/ASUS/OneDrive/Documentos/Gomory-Hu-Tree/output.txt", "r") as file:
            lines = file.readlines()

        # Dibujar el grafo del archivo output.txt
        dibujar_grafo("C:/Users/ASUS/OneDrive/Documentos/Gomory-Hu-Tree/output.txt", guardar_imagen=True)

    except FileNotFoundError:
        print("Error: El archivo de datos 'output.txt' no fue encontrado.")

# Eliminar un output.txt si existe
if os.path.exists("C:/Users/ASUS/OneDrive/Documentos/Gomory-Hu-Tree/output.txt"):
